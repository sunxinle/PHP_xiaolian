  ...
  <body ontouchstart>
    ...
    <form action="<?php echo U('home/match/go');?>" method="post">
      <div class='demos-content-padded' style="margin-top:80%;">
        ...
        <input type="submit" class="weui_btn weui_btn_primary" vaule="确认">
        <a href="javascript:;" onclick="history.go(-1)" class="weui_btn weui_btn_warn">取消</a>
      </div>
    </form>
...
$(document).ready(function(){
  $('#search-form').autocomplete({
    ...
    onSubmit: function(text){
      $('#message').html('<input type="hidden" name="university" value="'+text+'"/>' );
    }
  });
});
</script>
