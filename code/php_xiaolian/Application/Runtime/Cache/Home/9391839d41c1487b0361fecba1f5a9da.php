                ...
                <div class="weui_panel_bd">
                  <a href="<?php echo U('moments/detail',array('id'=>$vo['xlaid']));?>" class="weui_media_box weui_media_appmsg">
                    <div class="weui_media_hd">
                      <img class="weui_media_appmsg_thumb" src="/Public/<?php echo ($vo["xlaimageurl"]); ?>" alt="">
                    </div>
                  </a>
                </div>
              </p>
              <ul class="weui_media_info">
                <li class="weui_media_info_meta"><?php echo ($vo["xlaauthor"]); ?></li>
                <li class="weui_media_info_meta weui_media_info_meta_extra"><?php echo ($vo["xlaaddtime"]); ?></li>
              </ul>
