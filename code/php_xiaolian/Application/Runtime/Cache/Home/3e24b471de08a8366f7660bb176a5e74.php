...
<div class="weui_tab">
  ...
  <div class="weui_panel_bd">
    <div class="weui_media_box weui_media_text">
      <p class="weui_media_desc"> <div><a href="javascript:void(0);"><img src="/php_xiaolian/Public/images/swiper-3.jpg" width="98%" height="70%"></a></div></p>
      <h4 class="weui_panel_hd">我要去海底</h4>
    </div>
     <div class="weui_media_box weui_media_text">
      <p class="weui_media_desc"> <div><a href="javascript:void(0);"><img src="/php_xiaolian/Public/images/swiper-3.jpg" width="98%" height="70%"></a></div></p>
       <h4 class="weui_panel_hd">hha </h4>
    </div>
     <div class="weui_media_box weui_media_text">
      <p class="weui_media_desc"> <div><a href="javascript:void(0);"><img src="/php_xiaolian/Public/images/swiper-3.jpg" width="98%" height="70%"></a></div></p>
       <h4 class="weui_panel_hd">womennengxing</h4>
    </div>
  </div>
  ...
  <div class="weui_tabbar">
    <a href="javascript:;" class="weui_tabbar_item weui_bar_item_on">
      <div class="weui_tabbar_icon">
        <img src="/php_xiaolian/Public/images/toutiaoc.png" alt="">
      </div>
