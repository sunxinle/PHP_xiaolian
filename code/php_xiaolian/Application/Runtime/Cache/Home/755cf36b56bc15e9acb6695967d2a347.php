...
<script type="text/javascript">
    ...
    var showChatUI = function() {
        ...
        login_userEle.innerHTML = '';
        login_userEle.setAttribute("title", '');
    };
    //登录之前不显示web对话框
    ...
    $(document).ready(function() {
        ...
        $('#regist-div-modal').on('hidden.bs.modal', function(e) {
...
*/
    ...
    var handleRoster = function(rosterMsg) {
        for (var i = 0; i < rosterMsg.length; i++) {
            ...
            if (contact.subscription == 'both') {
                ...
                if (!isexist) {
                    var lielem = $('<li style="width: 100%; height:130px; background-color: rgb(51, 204, 255);">').attr({
                        "id" : contact.name,
                        "class" : "offline",
                        "className" : "offline"
                    }).click(function() {
                    ...
                    $('<img style=" width:100px;height:100px;display:block;float:left;margin-left:15%;padding-top:1%;">').attr({
                        "src" : "/Public/chatimg/head/contact_normal.png"
                    }).appendTo(lielem);

                    $('<span style="font-size:60px;display:block; float:left;margin-top:5%;margin-left:1%;">').html(contact.name).appendTo(lielem);
    ...
    var buildContactDiv = function(contactlistDivId, roster) {
        ...
        for (i = 0; i < roster.length; i++) {
            ...
            cache[userName] = true;
            var lielem = $('<li  style="width:100%;height:130px; ">').attr({
                'id' : userName,
                'class' : 'offline',
                'className' : 'offline',
                'type' : 'chat',
            ...
            $('<img style=" width:100px;height:100px;display:block;float:left;margin-left:15%;padding-top:1%;">').attr("src", "/Public/chatimg/head/contact_normal.png").appendTo(
                    lielem);
            $('<span style="font-size:60px;display:block; float:left;margin-top:5%;margin-left:1%;">').html("我是逗比?").appendTo(lielem);
            $('#contactlistUL').append(lielem);
        }
    ...
    var buildListRoomDiv = function(contactlistDivId, rooms) {
        ...
        for (i = 0; i < rooms.length; i++) {
            ...
            $('<img  style="width:100px;height:100px;display:block;float:left;margin-left:15%;padding-top:1%;">').attr({
                'src' : '/Public/chatimg/head/group_normal.png'
            }).appendTo(lielem);
            $('<span style="font-size:60px;display:block; float:left;margin-top:5%;margin-left:1%;">').html(roomsName).appendTo(lielem);
    ...
    var showContactChatDiv = function(chatUserId) {
        ...
        if (chatUserId.indexOf(groupFlagMark) >= 0) {
            dispalyTitle = $(contactLi).attr('displayname') ;
...
/*var lielem = $('<li  style="width:100%;height:130px; ">').attr({
            ...
            $('<img style=" width:100px;height:100px;display:block;float:left;margin-left:15%;padding-top:1%;">').attr("src", "img/head/contact_normal.png").appendTo(
                    lielem);
            $('<span style="font-size:60px;display:block; float:left;margin-top:5%;margin-left:1%;">').html("我是逗比?").appendTo(lielem);
            $('#contactlistUL').append(lielem);*/
    ...
    $('<span style="font-size:60px;display:block; float:left;margin-top:5%;margin-left:1%;">').html(who).appendTo(lielem);
    ...
    var appendMsg = function(who, contact, message, chattype) {
        ...
        var headstr =  [ "<textarea  readonly='true' style='text-align:center;width:40%;height:6%;font-size:40px;padding-top:35px;margin-bottom:-5px;background-color:#EBEBEB;'>" + who + " &nbsp;"+getLoacalTimeString() + " </textarea><br/>"];
        ...
        for (var i = 0; i < messageContent.length; i++) {
            ...
            if (type == "emotion") {
                ...
                var eletext = "<p3 style='width: 80%;line-height:1.4; font-size:50px;word-break:break-all;'>" + data + "</p3>";
                var ele = $(eletext);
                ele[0].setAttribute("class", "chat-content-p3");
                ele[0].setAttribute("className", "chat-content-p3");
                if (curUserId == who) {
                    ele[0].style.backgroundColor = "#98E496";
                }
                for (var j = 0; j < ele.length; j++) {
                    lineDiv.appendChild(ele[j]);
                }
        ...
        if (curChatUserId && curChatUserId.indexOf(contact) < 0) {
            ...
            if (badgespan && badgespan.length > 0) {
                ...
                $(contactLi).append('<span class="badge" style="font-size:29px;width:80px;height:70px;display:block;line-height:70px; text-align:center;margin-right:100px;margin-top:25px;">1</span>');
            }
            //联系人不同分组的未读消息提醒
            ...
            if (badgespanGroup && badgespanGroup.length == 0) {
                $(contactLi).parent().parent().parent().prev().children()
                        .append('<span class="badgegroup" style="font-size:29px;margin-top:-25px;width:80px;height:70px;display:block;line-height:70px; text-align:center;">New</span>');
            }
    ...
    var showAddFriend = function() {
        ...
        $('#addfridentId').val('sunchenyu');//输入好友账号
    ...
    var hiddenlist = function heddenlist(){
        $('#leftcontact').css({
            "display" : "none"
        });
        $('#chat007').css({
    ...
    var hiddenchat = function hiddenchat(){
        $('#leftcontact').css({
            "display" : "block"
        });
        $('#chat007').css({
   ...
   <div id="loginmodal" class="modal hide fade in" role="dialog"
        ...
        <div >
            <table>
                <tr>
                    <td width="65%">                     
                        <input type="hidden" name="username" value="guoying" id="username" tabindex="1"/>
                        <input type="hidden" name="password" value="guoying1" id="password" tabindex="2" />   
                    </td>
                </tr>
            </table>    
        </div>
        <div >
            <button  onclick="login()" tabindex="3">登录</button>
        </div>
    </div>
<!--用户登录界面-->
...
<!--等待进入聊天界面-->
    <div id="waitLoginmodal" class="modal hide fade" data-backdrop="static">
        <img src="/Public/chatimg/waitting.gif">waiting</img>
    </div>
<!--等待进入聊天界面-->


    <div id="content" style="display:none"style="height:100% !important;">

        <div id="leftcontact" style="display: block; margin-top:0%;">
            <!--左上部分-->
            <div id="headerimg" class="leftheader" style="background-color:#29b6f6;width:100%; height:150px;">

                <span  >
                    <div class="btn-group" style="margin-left:5%;">
                        <!-- <button class="btn btn-inverse dropdown-toggle"    data-toggle="dropdown" style="width:70px;height:50px;"> -->
                        <img class="btn dropdown-toggle" data-toggle="dropdown" src="/Public/chatimg/friend.jpg"style="width:70px;height:70px;margin-top:35%;">
                            

                        </button>
                        <ul class="dropdown-menu"  style="width:600px;height:240px;">
                            <li style="width:600px;height:120px;"><a href="#" onclick="showAddFriend()"style="width:540px;height:70px; font-size:70px;padding-top:50px ;padding-left:40px;">添加好友</a></li>
                            <li style="width:600px;height:120px;"><a href="#" onclick="showDelFriend()" style="width:540px;height:70px;font-size:70px;padding-top:50px;padding-left:40px;">删除好友</a></li>
                            <!-- <li class="divider" > </li> -->
                            <!-- <li style="width:570px;height:130px;"><a href="#" onclick="logout()" style="width:530px;height:110px;">退出</a></li> -->
                        </ul>
                    </div>
                </span>

                <span id="login_user" class="login_user_title" style="width:40px; height:40px; margin-top:30px; margin-right:70%;" > 
                     <a class="leftheader-font" href="#" ></a>  
                </span> 
            
                <span> <img src="/Public/chatimg/head/header2.jpg" alt="logo" class="img-circle" width="80px" height="80px"
                    style="margin-top: -9%; margin-left:85%;"/>
                </span> 
            ...
            <!--左下部分开始-->
            <div id="contractlist11" style="height: 92%; width:100%;overflow-y: auto; overflow-x: auto;" >
                <div class="accordion" id="accordionDiv">
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading" style="width:100%px;height:130px; ">
                            ...
                            href="#collapseOne" style="font-size:60px;padding-top:60px ;padding-left:300px; padding-right:136px;width:540px;height:75px; ">
                            我的好友</a>
                        </div>
                        <div id="collapseOne" class="accordion-body collapse in" >
                            <div class="" id="contractlist" > 
                                <ul id="contactlistUL" class="chat03_content_ul" onclick="hiddenlist()" style="width:100%;"></ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a id="accordion2" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordionDiv"
                                href="#collapseTwo" style="font-size:60px;padding-top:60px ;padding-left:300px; padding-right:136px;width:540px;height:75px; ">我的群组</a>
                        </div>
                        <div id="collapseTwo" class="accordion-body collapse">
                            <div class="" id="contracgrouplist">
                                <ul id="contactgrouplistUL" class="chat03_content_ul" onclick="hiddenlist()"></ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a id="accordion3" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordionDiv"
                                 href="#collapseThree" style="font-size:60px;padding-top:60px ;padding-left:300px; padding-right:136px;width:540px;height:75px; ">陌生人</a>
                        </div>
                        <div id="collapseThree" class="accordion-body collapse">
                            <div class="accordion-inner" id="momogrouplist">
                                <ul id="momogrouplistUL" class="chat03_content_ul" onclick="hiddenlist()"></ul>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--*********************************************************************************************************-->
        ...
        <div id="addFridentModal" class="modal hide fade" role="dialog" aria-hidden="true" data-backdrop="static" style="margin-left: -35%; width: 70%; height: 30%; display: block;">
            <div class="modal-header" style="height:20%;">
                <button type="button" class="close" data-dismiss="modal"
                    aria-hidden="true" style="height:100%;width:13%;"><img src="/Public/chatimg/back1.png" 
            ...
            <div class="modal-body">
                <input id="addfridentId" onfocus='clearInputValue("addfridentId")' style="height:20%;width:100%;margin-top:5%;font-size:70px;"/>
                <div id="add-frident-warning"  style="height:20%;width:100%;margin-top:5%;font-size:70px;"></div>
            </div>

            <div class="modal-footer">
                <button id="addFridend" class="btn btn-primary"
                    onclick="startAddFriend()" style="width:47%;height:20%;font-size:70px;">添加</button>
                <button id="cancelAddFridend" class="btn" data-dismiss="modal" style="width:47%;height:20%;font-size:70px;">取消</button>
            </div>
        ...
        <div id="delFridentModal" class="modal hide fade" role="dialog"
            ...
            <div class="modal-body">
                <input id="delfridentId" onfocus='clearInputValue("delfridentId")' style="height:20%;width:100%;margin-top:5%;font-size:70px;"/>
                <div id="del-frident-warning"  style="height:20%;width:100%;margin-top:5%;font-size:70px;"></div>
            </div>
            <div class="modal-footer">
                <button id="delFridend" class="btn btn-primary"
                    onclick="directDelFriend()" style="width:47%;height:20%;font-size:70px;">删除</button>
                <button id="canceldelFridend" class="btn" data-dismiss="modal" style="width:47%;height:20%;font-size:70px;">取消</button>
            </div>
        </div>
        <!--删除好友结束-->
        ...
        <div id="notice-block-div" class="modal fade hide" style="margin-left: -35%; width: 70%; height: 30%; display: block;">
            ...
            <div class="modal-body">
                ...
                <div id="notice-block-body"  style="height:20%;width:100%;margin-top:5%;font-size:70px;"></div>
            </div>
        </div>
        <!-- 一般消息通知结束 -->

        <!-- 确认消息通知开始 -->
        <div id="confirm-block-div-modal" class="modal fade hide" role="dialog" aria-hidden="true" data-backdrop="static"  style="margin-top:-30%;margin-left: -35%; width: 70%; height: 45%; display: block;">
            <div class="modal-header" style="height:20%;">
                <h3 style="text-align:center;font-size:80px;padding-top:7%;">订阅通知</h3>
            </div>
            <div class="modal-body">
                <div id="confirm-block-footer-body" style="height:50%;width:100%;font-size:70px; line-height:2.0;"></div>
            </div>
            <div class="modal-footer">
                <button id="confirm-block-footer-confirmButton" class="btn btn-primary" style="width:47%;height:20%;font-size:70px;">同意</button>
                <button id="confirm-block-footer-cancelButton" class="btn" data-dismiss="modal" style="width:47%;height:20%;font-size:70px;">拒绝</button>
            </div>
        </div>
<!-- 确认消息通知 -->
...
<!--********************************************************************************************-->
        ...
        <!-- 聊天页面 -->
        <div class="chatRight"  id="chat007" style="display:none;width:100%;height:100%;margin-left:0px;padding-left:0px;">

            <div id="chat01" style="width:100%;margin-left:0px;padding-left:0px;">

                <div class="chat01_title"style="height:150px;background-color:#29b6f6;" >
                    <ul class="talkTo" style="">
                         <li ><img src="/Public/chatimg/back.png" onclick="hiddenchat();" width="70px" height="70px"
                            style=" margin-right:25px;margin-top:25px; cursor:hand; width: 70px;height:70px;" title="返回" />
                        </li>
                         <li id="talkTo" ><a href="#" style="margin-top:12%;font-size:70px;display:block;"></a></li> 
                        <li id="recycle" style="float: right;"><img src="/Public/chatimg/recycle.png" onclick="clearCurrentChat();"
                            style="margin-right: 15px; margin-top:25px; cursor:hand; width: 70px;height:70px;" title="清屏" />
                        </li>
                        <li id="roomInfo" style="float: right;"><img id="roomMemberImg"
                            src="/Public/chatimg/head/find_more_friend_addfriend_icon.png" style="width:80px;height:80px; margin-top:22%;" onclick="showRoomMember();"
                            style="margin-right: 15px; cursor: hand; width: 18px; display: none" title="群组成员" />
                        </li>
                    </ul>
                </div>
          ...
          <!--发送图片 表情，语音-->
            <div class="chat02" >
                ...
                <!--    <a class="chat02_title_btn ctb01" onclick="showEmotionDialog()" title="选择表情"></a> 
                    ...
                    <a class="chat02_title_btn ctb02" onclick="showSendAudio()" href="#"title="选择语音"><span></span></a> 
                ...
                <div id="input_content" class="chat02_content">
                        <textarea id="talkInputId" style="border:solid 8px grey;width:85%;height:108px;display:block;float:left;font-size:86px;line-height:1;overflow-y:visible;"></textarea>
                    <img src="/Public/chatimg/send_btn.jpg" onclick="sendText()" style="width:140px;height:110px;display:block;float:left;"/>
                </div>
    ...
    <!--        <div id="fileModal" class="modal hide fade" role="dialog" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-body">
                    <input type='file' id="fileInput" /> <input type='hidden' id="sendfiletype" />
...
<!--************************************************************************-->
        <!-- 群组成员操作界面 -->
        <div id="option-room-div-modal" class="alert modal fade hide" role="dialog" aria-hidden="true" data-backdrop="static">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true" >&times;</button>
