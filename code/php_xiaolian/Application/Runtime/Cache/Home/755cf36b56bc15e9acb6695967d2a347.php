...
<head>
    ...
    <script type="text/javascript">
        ...
        var appendMsg = function(who, contact, message, chattype) {
            ...
            var headstr =  [ "<textarea  readonly='true' style='text-align:center;width:40%;font-size:40px;padding-top:35px;margin-bottom:-5px;background-color:#EBEBEB;'>" + who + " &nbsp;"+getLoacalTimeString() + " </textarea><br/>"];
...
<body>
            ...
            <table>
                <tr>
                    <td width="65%">
                        ...
                        <input type="text" name="username" value="guoying" id="username" tabindex="1"/>
                        <label for="password">密码:</label>
                        <input type="password" name="password" value="guoying1" id="password" tabindex="2" />
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div id="waitLoginmodal" class="modal hide fade" data-backdrop="static">
        <img src="/Public/chatimg/waitting.gif">加载中</img>
    </div>
    <!--等待进入聊天界面-->
    ...
    <div id="content" style="display:none"style="height:100% !important;">
        ...
        <div id="leftcontact" style="display: block; margin-top:0%;">
            <!--左上部分-->
            <div id="headerimg" class="leftheader" style="width:100%; height:150px;">
            ...
            <!--左下部分开始-->
            <div id="contractlist11"  style="height: 98%; width:100%; overflow-y: auto; overflow-x: auto;">
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a id="accordion2" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordionDiv"
                               href="#collapseTwo" style="font-size:60px;padding-top:60px ;padding-left:300px; padding-right:200px;width:540px;height:75px; ">我的群组</a>
                        </div>
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a id="accordion3" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordionDiv"
                               href="#collapseThree" style="font-size:60px;padding-top:60px ;padding-left:300px; padding-right:200px;width:540px;height:75px; ">陌生人</a>
                        </div>
        ...
        <div class="chatRight"  id="chat007" style="display:none;width:100%;height:100%;margin-left:0px;padding-left:0px;">
            ...
            <div id="chat01" style="width:100%;margin-left:0px;padding-left:0px;">
                ...
                <div class="chat01_title"style="height:150px;" >
                    <ul class="talkTo" style="">
                        <li ><img src="/Public/chatimg/recycle.png" onclick="hiddenchat();"
            ...
            <div class="chat02" >
                ...
                <div id="input_content" class="chat02_content">
                    <input id="talkInputId" style="width:85%;height:110px;display:block;float:left;font-size:40px;">
