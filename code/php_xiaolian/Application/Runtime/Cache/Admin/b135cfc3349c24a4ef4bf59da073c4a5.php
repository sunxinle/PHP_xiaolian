        ...
        <div class="result-wrap">
            <div class="result-content">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <td>
                                <h1 style="font-size: 26px" align="center"><?php echo ($result["uniname"]); ?></h1>
                                <p style="font-size: 12px" align="center">所在地点：<?php echo ($result["uniaddress"]); ?></p>
                                <img src="/Public/<?php echo ($result["uniimage"]); ?>" alt="picture">
                                <p><?php echo ($result["unidescription"]); ?></p>
                            </td>
                        </tr>
                        </tbody></table>
            </div>
